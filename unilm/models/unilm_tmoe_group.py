...
from unilm.modules.tmoe_group import Top1Gate, Top2Gate, MOELayer
...
@dataclass
class UniLMTMoEModelConfig(UniLMGshardModelConfig):
    # parameters for tmoe
...
@register_model("unilm_tmoe_group", dataclass=UniLMTMoEModelConfig)
class UniLMTMoEModel(UniLMModel):
    @classmethod
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_base")
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_xlarge_24L")
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_xlarge_24L_post")
def xlarge_24L_unilm_architecture(args):
    args.encoder_embed_dim = safe_getattr(args, "encoder_embed_dim", 2048)
    args.encoder_ffn_embed_dim = safe_getattr(args, "encoder_ffn_embed_dim", 8192)
    args.encoder_layers = safe_getattr(args, "encoder_layers", 24)
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_xlarge_48L")
def xlarge_24L_unilm_architecture(args):
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_xlarge_36L")
def xlarge_24L_unilm_architecture(args):
    args.encoder_embed_dim = safe_getattr(args, "encoder_embed_dim", 1536)
    args.encoder_ffn_embed_dim = safe_getattr(args, "encoder_ffn_embed_dim", 6144)
...
@register_model_architecture("unilm_tmoe_group", "unilm_tmoe_group_xsmall")
