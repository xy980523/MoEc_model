...
from unilm.models.unilm_gdmoe import UniLMMoeLayer, UniLMGDMoEModelConfig, make_experts
from unilm.modules.gshard.utils_s2s import load_moe_ckpt
from unilm.modules.gdmoe import Top1Gate, Top2Gate, MOELayer

@register_model("gdmoe")
class GDMoEModel(TransformerModel):
    """
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--use-all2all-v2', action='store_true',
                            help='apply layernorm before each decoder block')

        gen_parser_from_dataclass(
            parser, UniLMGDMoEModelConfig(), delete_default=False, with_prefix=""
        )
...
@register_model_architecture("gdmoe", "gdmoe")
...
@register_model_architecture("gdmoe", "gdmoe_tiny")
...
@register_model_architecture("gdmoe", "gdmoe_iwslt_de_en")
...
@register_model_architecture("gdmoe", "gdmoe_wmt_en_de")
