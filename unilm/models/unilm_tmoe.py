...
@register_model("unilm_tmoe", dataclass=UniLMTMoEModelConfig)
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_base")
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_xlarge_24L")
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_xlarge_24L_post")
def xlarge_24L_unilm_architecture(args):
    args.encoder_embed_dim = safe_getattr(args, "encoder_embed_dim", 2048)
    args.encoder_ffn_embed_dim = safe_getattr(args, "encoder_ffn_embed_dim", 8192)
    args.encoder_layers = safe_getattr(args, "encoder_layers", 24)
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_xlarge_48L")
def xlarge_24L_unilm_architecture(args):
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_xlarge_36L")
def xlarge_24L_unilm_architecture(args):
    args.encoder_embed_dim = safe_getattr(args, "encoder_embed_dim", 1536)
    args.encoder_ffn_embed_dim = safe_getattr(args, "encoder_ffn_embed_dim", 6144)
...
@register_model_architecture("unilm_tmoe", "unilm_tmoe_xsmall")
